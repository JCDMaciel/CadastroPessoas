...
public class AlterarPessoaRegrasTest {
    ...
    @Test
    public void test_service_alterar_called_once_for_valid_pessoa() {
        PessoaService service = mock(PessoaService.class);
        AlterarPessoaRegras regras = new AlterarPessoaRegras(service);
        Pessoa pessoa = new Pessoa(1L, "Valid Name", null, new Contato("(12) 34567-8910"));
        when(service.alterar(pessoa)).thenReturn(pessoa);
    ...
    public void test_no_alteration_if_validation_fails() {
        ...
        Pessoa pessoa = new Pessoa(1L, null, null, new Contato("(12) 34567-8910"));
        assertThrows(IllegalArgumentException.class, () -> regras.execute(pessoa));
        verify(service, never()).alterar(any(Pessoa.class));
    }

    @Test
    public void test_all_validations_called_in_sequence() {
        PessoaService service = mock(PessoaService.class);
        AlterarPessoaRegras regras = spy(new AlterarPessoaRegras(service));
        Pessoa pessoa = new Pessoa(1L, "Valid Name", null, new Contato("(12) 34567-8910"));
        ...
        when(service.alterar(any(Pessoa.class))).thenReturn(pessoa);
        ...
        verify(service).alterar(any(Pessoa.class));
    }
    ...
    public void test_nome_null() {
        ...
        AlterarPessoaRegras regras = new AlterarPessoaRegras(pessoaServiceMock);
    ...
    public void test_trims_leading_spaces() {
        ...
        AlterarPessoaRegras regras = new AlterarPessoaRegras(null);
